...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/ngyngy/qiaomu-blog-opensource)

分享资源、记录行业，未来10年，关注比特币和AI。

基于 [Qiaomu Blog Open Source](https://github.com/joeseesun/qiaomu-blog-opensource) 二次开发，一套完整的博客系统：前后台双编辑器、AI 写作辅助、AI 生图、主题系统、全文检索、API Token、外部发布生态。

- 在线站点：<https://blog.ngy123.com/>
- 当前仓库：<https://github.com/ngyngy/qiaomu-blog-opensource>
- 原项目：<https://github.com/joeseesun/qiaomu-blog-opensource>
...
- [`ecosystem/nangongyuan-blog-publish-skill`](ecosystem/nangongyuan-blog-publish-skill/README.md)：通过 Claude Skill / 命令工作流直接发布
...
npx wrangler login
npm run cf:init -- --site-url=https://blog.ngy123.com
npm run build
npm run deploy
```
...
```bash
git clone https://github.com/ngyngy/qiaomu-blog-opensource.git
...
- nangongyuan
- GitHub：<https://github.com/ngyngy>
- X / Twitter：<https://x.com/nangongyuan>
- Blog：<https://blog.ngy123.com/>

## 致谢

本项目基于 [Qiaomu Blog Open Source](https://github.com/joeseesun/qiaomu-blog-opensource)（作者：[向阳乔木](https://github.com/joeseesun)）开源，遵循 MIT 协议。
