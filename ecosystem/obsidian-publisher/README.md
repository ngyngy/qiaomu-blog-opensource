# obsidian-nangongyuan-blog-publisher

一键将 Obsidian 笔记发布到你自己的 南宫远的博客 草稿箱。
...
1. 下载 `main.js`、`manifest.json` 到你的 Obsidian 插件目录：
   ```
   {你的笔记库}/.obsidian/plugins/nangongyuan-blog-publisher/
   ```
...
1. 打开 Obsidian 设置 > 第三方插件 > 南宫远的博客 Publisher
2. 填写 API 地址（默认 `https://blog.ngy123.com`）
3. 填写 API Token（在你的博客后台获取）

## 使用

- **命令面板**：`Ctrl/Cmd + P` > 搜索 “发布到 南宫远的博客”
- **侧边栏图标**：点击上传图标
